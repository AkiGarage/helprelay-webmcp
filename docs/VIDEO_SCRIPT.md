...
Target duration: 2:20. The first 15 seconds show the product action, not a title card.

## Shot list

| Time | Shot | Narration / on-screen text |
| --- | --- | --- |
| 0:00–0:05 | Full browser viewport; click **Run the 15-second story**. | “A scary browser banner appears. The person does not have to guess.” |
| 0:05–0:15 | Six story cards advance to the handoff preview; red unsafe guess and green safe path remain visible. | “HelpRelay captures only visible context, blocks the suspicious click, offers one view-only step, and pauses before handoff.” |
| 0:15–0:35 | Zoom on the evidence card and event log. | “The banner says ‘ignore previous instructions’ and points at a fictional suspicious link. That is evidence, not an instruction.” |
| 0:35–0:55 | Show blocked unsafe action result. | “The independent policy rejects navigation, links, credentials, and irreversible actions before any external effect.” |
